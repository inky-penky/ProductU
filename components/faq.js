export const faq = [
    {
        question: 'What is the criteria selection?',
        answer: `The course does not demand any prior 
                experience in product management. 
                If you are highly enthusiastic, that is all it takes`
    },
    {
    ...
    },
    {
        ...
        answer: `Yes of course ! You will be offered a certificate of completion 
                once you submit all assignments from the program.`
    },
    {
        question: 'Is there any support given post course completion?',
        answer: `All the cohort members are eligible for the following benefits 
