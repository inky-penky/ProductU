    ...
    return(
      ...
      <div className="bg-hero -z-30 bg-cover">
          <div className="mt-10 h-36 flex justify-between flex-col">
            <motion.div ref={ref} animate={animation1}
              className="flex justify-center text-center">
              <div className="mt-36 leading-[3rem] w-[420px] font-semibold m-0 mb-4 text-darkblue text-2xl flex self-center tracking-wider lg:w-[450px]">Become A Product Manager In 12 Weeks</div>
            </motion.div>
