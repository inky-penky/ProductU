    ...
    return(
      ...
      <div className="h-36 flex justify-between flex-col">
        <div className="flex justify-center text-center">
          <div className="leading-[3rem] w-[420px] font-semibold m-0 mb-4 mt-20 text-darkblue text-2xl flex self-center tracking-wider md:w-[450px]">Become A Product Manager In 12 Weeks</div>
        </div>
      <p className="m-0 mb-6 w-fit relative font-normal top-4 text-lg tracking-wider lg:flex justify-center self-center">No Prior Experience required *</p>
