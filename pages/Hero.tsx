    ...
    return(
      ...
      <div className="h-36 flex justify-between flex-col">
        <div className="flex justify-center text-center">
          <div className="w-[350px] font-semibold m-0 text-blue-800 text-2xl flex self-center tracking-wider md:w-[400px]">Become A Prduct Manager In 12 Weeks</div>
        </div>
      ...
      <button className="w-56 relative top-10 p-3 font-bold rounded-3xl m-0 font-mono bg-gradient-to-r from-cyan-500 to-blue-800  text-white md: flex justify-center self-center md:-mb-4">Apply for Program</button>
      </div>
      <div className="flex justify-center">
      <div className="w-64 p-10 pl-16 pb-8 relative m-0 mt-28 mb-6 bg-slate-200 rounded-[70px] md:pb-6 md:rounded-[300px] md:w-auto">
